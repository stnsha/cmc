    ...
    <div class="flex flex-col sm:m-[35px]">
        ...
        <div class="flex flex-col sm:flex-row">
            <div>
                ...
                @else
                <img src="{{ asset('img/abc1.jpg') }}" class="max-w-full h-auto">
                @endif
            </div>
            <div class="flex flex-col justify-center items-center mx-0 sm:mx-[50px]">
                <span class="text-2xl font-bold text-center sm:mb-4">{{ $venue->venue_name.',
                ...
                <form action="{{ route('submit_venue') }}" method="post">
                    ...
                    <div class="flex w-full inline-flex items-center my-2 border-b">
                        ...
                        <div class="flex flex-col w-1/2">
                            ...
                            @if ($venue->id == 1)
                            <a href="{{ route('order_form', ['venue_id' => 2]) }}"
                                class="text-sm font-normal text-brown-cream hover:underline">Tukar tempat</a>
                            @else
                            <a href="{{ route('order_form', ['venue_id' => 1]) }}"
                                class="text-sm font-normal text-brown-cream hover:underline">Tukar tempat</a>
                            @endif
                        </div>
                    </div>
